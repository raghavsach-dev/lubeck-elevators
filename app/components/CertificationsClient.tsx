      ...
      <div className="bg-black text-white min-h-screen pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h1 className="font-heading text-5xl md:text-6xl font-bold text-[#D4AF37]">Our Certifications</h1>
          ...
          <div className="flex flex-wrap justify-center gap-10">
            {certifications.map((cert, index) => (
              <div key={index} onClick={() => setSelectedPdf(cert)} className="group cursor-pointer relative w-80">
                <div className="bg-[#1C1C1C] border border-white/10 rounded-xl p-6 text-center transition-all duration-300 transform hover:-translate-y-2 hover:border-[#D4AF37] hover:shadow-2xl hover:shadow-[#D4AF37]/20 overflow-hidden">
                  ...
                  <h3 className="font-heading text-xl font-semibold text-white/90 transition-colors duration-300 h-12 flex items-center justify-center">{cert.name}</h3>
                </div>
