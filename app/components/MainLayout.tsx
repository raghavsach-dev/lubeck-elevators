          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="hidden md:flex items-center space-x-6">
                ...
                <Link href="/downloads" className="hover:text-[#D4AF37] transition-colors duration-300">Downloads</Link>
      ...
      <footer className="bg-black border-t border-white/10 py-8">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-white/60">
            ...
            <div>
              ...
              <p className="text-sm">309, 3rd Floor, Angel Mega Mall, Kaushambi, Ghaziabad 201010</p>
