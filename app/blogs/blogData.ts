...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `
      ...
      <div class="my-8"><img src="/lift-sample.jpg" alt="Lubeck Elevator interior showing luxury design" width="800" height="500" class="rounded-lg shadow-2xl mx-auto" /></div>
