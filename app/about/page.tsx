    ...
    <div className="bg-black text-white min-h-screen pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center">
          <h1 className="font-heading text-5xl md:text-6xl font-bold text-[#D4AF37]">About Lubeck Elevators</h1>
          <p className="text-lg text-white/70 mt-4 max-w-3xl mx-auto">Lifting With Luxury Since 2009</p>
        </div>
        ...
        <div className="mt-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div>
                <h2 className="font-heading text-4xl font-bold text-[#D4AF37] mb-4">Our Mission</h2>
                <p className="text-lg text-white/80 leading-relaxed">To ascend as the premier elevator company by delivering unparalleled vertical transportation solutions. We are committed to innovation, quality, and customer satisfaction, ensuring every journey with Lubeck Elevators is a testament to our dedication to excellence.</p>
              </div>
              <div>
                <h2 className="font-heading text-4xl font-bold text-[#D4AF37] mb-4">Our Vision</h2>
                <p className="text-lg text-white/80 leading-relaxed">To redefine the standards of the elevator industry by integrating cutting-edge technology with sustainable practices. We envision a future where our elevators not only enhance accessibility but also contribute to smarter, more efficient urban environments, elevating the quality of life for all.</p>
              </div>
            </div>
